...
// VM instructions
enum { LEA ,IMM ,JMP ,CALL,JZ  ,JNZ ,ENT ,ADJ ,LEV, RET ,LI  ,LC  ,SI  ,SC ,SET,GET,
  PUSH = 0x10, GETELEM, SETELEM, ADDELEM, OR  ,XOR ,AND ,EQ  ,NE  ,LT  ,GT  ,LE  ,GE  ,SHL ,SHR ,ADD ,
    SUB =0x20 ,MUL ,DIV ,MOD , OPEN,READ,CLOSE,PRTF,MALC,MSET,MCMP,EXIT = 0x2b };
